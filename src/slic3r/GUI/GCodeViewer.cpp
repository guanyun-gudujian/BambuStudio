...
namespace Slic3r {
    namespace GUI {
        namespace gcode
        {
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_moves_slider();
                }
                return nullptr;
            }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_layers_slider();
                }
                return nullptr;
            }
            ...
            {
                if (m_p_renderer) {
                    m_p_renderer->on_change_color_mode(is_dark);
                }
            }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_paths_bounding_box();
                }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_max_bounding_box();
                }
                static BoundingBoxf3 s_empty;
                return s_empty;
            }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_shell_bounding_box();
                }
                static BoundingBoxf3 s_empty;
                return s_empty;
            }
            ...
            {
                if (m_p_renderer) {
                    m_p_renderer->refresh(gcode_result, str_tool_colors);
                }
            }
            void GCodeViewer::refresh_render_paths()
            {
                if (m_p_renderer) {
                    m_p_renderer->refresh_render_paths();
                }
            }
            void GCodeViewer::toggle_gcode_window_visibility()
            {
                if (m_p_renderer) {
                    m_p_renderer->toggle_gcode_window_visibility();
                }
            }
            ...
            {
                if (m_p_renderer) {
                    m_p_renderer->export_toolpaths_to_obj(filename);
                }
            }
            bool GCodeViewer::has_data() const
            {
                if (m_p_renderer) {
                    return m_p_renderer->has_data();
                }
                return false;
            }
            ...
            {
                if (m_p_renderer) {
                    m_p_renderer->update_marker_curr_move();
                }
            }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_layers_z_range();
                }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_max_print_height();
                }
                return 0.0f;
            }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_gcode_check_result();
                }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_filament_printable_result();
                }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->get_conflict_result();
                }
            ...
            {
                if (m_p_renderer) {
                    return m_p_renderer->reset_curr_plate_thermal_options();
                }
            }
